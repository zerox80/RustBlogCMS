use rust_blog_backend::security::auth::{create_jwt, verify_jwt, init_jwt_secret, Claims};
use std::env;

#[test]
fn test_jwt_lifecycle() {
    // Setup secret
    env::set_var("JWT_SECRET", "this_is_a_very_long_test_secret_for_jwt_checks_12345_ABC_abc_!!!");
