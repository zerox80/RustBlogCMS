...
export const EditProvider = ({ children }) => {
  ...
  const toggleEditMode = () => {
    ...
    setEditingSession((currentSession) => (currentSession === activeSession ? null : activeSession))
  }

  return (
    <EditContext.Provider value={{ isEditing, toggleEditMode }}>{children}</EditContext.Provider>
  )
}
