...
## Overview
This directory contains translation files for the minos project. The application supports multiple languages using the i18next framework, with JSON files defining translations for each supported language.
