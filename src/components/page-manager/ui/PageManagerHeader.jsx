...
dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800`}
      ...
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-lg border border-primary-200 px-4
py-2 text-sm font-medium text-primary-700 hover:bg-primary-50
disabled:opacity-60 dark:border-primary-900/50 dark:text-primary-200
