      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-base font-medium text-gray-900 dark:text-white">PDF Download</h3>
            ...
            <button
              ...
              className={[
                ...
                settings.pdfEnabled ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700',
              ].join(' ')}
              role="switch"
            ...
            >
              <span
                ...
                className={[
                  ...
                  settings.pdfEnabled ? 'translate-x-5' : 'translate-x-0',
                ].join(' ')}
              />
            </button>
          </div>
          ...
          <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="flex flex-col gap-4">
              <div>
                <h3 className="text-base font-medium text-gray-900 dark:text-white">Startseite</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              <div className="w-full max-w-md">
                <select
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, homePageSlug: e.target.value }))
                  }
                  className={`block w-full rounded-md border-gray-300 dark:border-gray-600
dark:bg-slate-800 shadow-sm focus:border-blue-500 focus:ring-blue-500
sm:text-sm p-2.5`}
                >
