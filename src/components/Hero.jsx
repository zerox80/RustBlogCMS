...
const Hero = () => {
  ...
  return (
    <section
      className={`relative isolate overflow-hidden bg-gradient-to-br from-slate-950
via-slate-900 to-primary-950 text-white`}
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center space-y-10">
          <div
            className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border
border-white/20 text-sm font-medium`}
          >
            <Sparkles className="w-4 h-4" />
            <span>{heroContent.badgeText}</span>
          </div>
          <div
            className={`mx-auto flex h-24 w-24 items-center justify-center rounded-2xl border
...
transition-colors duration-300 hover:border-primary-400/40`}
                >
                  <div
                    className={[
                      'inline-flex rounded-xl bg-gradient-to-br p-3 shadow-md',
