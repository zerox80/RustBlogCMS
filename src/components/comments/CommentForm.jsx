      ...
      {!isAuthenticated && (
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full md:w-1/2 px-4 py-2 border border-gray-300 dark:border-gray-600
...
dark:text-gray-400 dark:hover:text-gray-200`}
      ...
      <div className="mt-2 flex justify-between items-center">
        <span className="text-sm text-gray-500 dark:text-gray-400">{newComment.length}/1000</span>
        <button
          type="submit"
